...
public struct CharacterSetupTest
{
    public Role role;
    public int level;
    public Item item;
...
public class BattleManagerTest : Singleton<BattleManagerTest>
{
    ...
    private GameObject CreateMob(CharacterSetupTest setup, GameObject spot, Orientation orientation)
    {
    ...
    public void InstanciateTeam(List<GameObject> mobs, List<CharacterSetupTest> mobSetups, List<GameObject> spots, Orientation orientation)
    {
        if (mobs.Count > 0)
            return;
